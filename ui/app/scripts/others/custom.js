...
// Mobile nav
  ...
  $(function () {
    ...
    quoteControl.eq(0).click(function () {
      firstQuotes.fadeIn(500);
    });
    quoteControl.eq(1).click(function () {
      secondQuotes.fadeIn(500);
    });
    quoteControl.eq(2).click(function () {
      thirdQuotes.fadeIn(500);
    });
  ...
  $(function () {
    ...
    $('.screenshot').click(function () {
      ...
      lb.children('img').attr('src', 'img/shots/' + lbImageStr);
    });
