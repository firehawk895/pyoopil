angular.module 'Pyoopil.Controllers'
  .controller 'classroomCtrl', ['$scope', '$templateCache', 'classroomService', '$state', '$timeout','mainService', ($scope, $templateCache, classroomService, $state, $timeout, mainService)->
