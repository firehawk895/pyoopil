...
<body>
            ...
            <div class="">
                <div class="sitewidth">
                    ...
                    <div class="mainnav clearfix">
                        <ul>
                            <li><a href="#whatispyoopil" class="first">What’s Pyoopil?</a>
                            </li>
    ...
    <!-- What is Pyoopil -->
    <div class="section">
        <section class="whatispyoopil box" id="whatispyoopil">
            <div class="sitewidth">
                <div class="pyoopil-left">
                    <h1>This is just dummy text which explains about ’what is Pyoopil’</h1>
                    ...
                    <ul class="share-slider">
                        <li>
                            <div class="shareleft">
                                ...
                                <p>Pyoopil gives you freedom to ask your doubts or share anything through discussions</p>
        ...
        <section class="footersection clearfix">
            <div class="sitewidth clearfix">
                <div class="clearfix footerbtm">
                    <div class="coprgts">
                        <p>Copyright 2014 Pyoopil.com</p>
                    </div>
