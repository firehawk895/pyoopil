...
(function($, window, document) {
  var $document, Landing;
  $document = $(document);
  Landing = (function() {
    function Landing(elem) {
    ...
    Landing.prototype.getClassroomsData = function() {
      var promise;
    ...
    Landing.prototype.setEventListeners = function() {
    ...
    Landing.prototype.newClassroomSubmit = function(e) {
      var ajax;
      e.preventDefault();
    ...
    Landing.prototype.joinClassroomSubmit = function(e) {
      var ajax;
      e.preventDefault();
    ...
    Landing.prototype.classroomsRendered = function(e, isInitial) {
      if (isInitial === true) {
  ...
  return App.classrooms.landing = Landing;
})($, window, document);
