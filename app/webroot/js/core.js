...
function showError(responseText, xhr, error) {
        // console.debug(xhr); 
        // console.debug(error);
...
$(".close-link").click(function (event) {
    ...
    // if(currentState!= null && currentState.thestate == "login") {
    //     window.history.back();
    // }
...
$("#dialog-link").click(function (event) {
    $("#dialog").dialog("open");
    $('.ui-widget-overlay').addClass('custom-overlay');
    history.pushState({thestate : "login"}, "dummy", "login");
});
...
$("#close-create-cls").click(function (event) {
    console.log("closing");
